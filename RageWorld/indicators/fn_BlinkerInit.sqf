...
File: fn_BlinkerInit.sqf
	Author:Ragebone 	
	Description:
	is called when someone turns his indecators  ON or OFF via the Keyhandler.	
	By pressing  Shift + Q /E  ore just Tab ore Shift + Tab.  :D 	
*/
...
switch(_indicator)do{
	...
	default{hint" du bist bei default init Blinker, smoething went wrong!";};
};